...
echo "Load POS\n";
loadPOSTags("resources/paisa.pos");
...
//    $result=getResultNumeric($data['type']);
    $features=[];
...
//    file_put_contents("my/dt/${DTYPE}_${DFILE}_result.txt",$result."\n",FILE_APPEND);

}

@mkdir("my/dt");
file_put_contents("my/dt/${DTYPE}_${DFILE}_features.txt","");
file_put_contents("my/dt/${DTYPE}_${DFILE}_result.txt","");
