...
# cu stem
#dt=ensemble.RandomForestClassifier(n_estimators=1000,criterion="entropy",max_depth=8,max_features='auto',min_samples_leaf=3,min_samples_split=2)
dt=ensemble.RandomForestClassifier(n_estimators=1000,criterion="entropy",max_depth=10,max_features='auto',min_samples_leaf=3,min_samples_split=2)
