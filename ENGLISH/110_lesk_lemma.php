...
function processWord($data,$line){
	...
	file_put_contents("my/lesk_lemma.$DFILE.tsv",implode("\t",array_merge(array_slice($line,0,4),[$decision]))."\n",FILE_APPEND);
}



//loadVectorsGZ("cc.en.300.vec.gz");
file_put_contents("my/lesk_lemma.${DFILE}.tsv","");
